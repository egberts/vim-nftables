...
syn match nft_sctp_hdr_field_sport "sport" contained skipwhite

hi link   nft_sctp_hdr_field_dport nftHL_Action
syn match nft_sctp_hdr_field_dport "dport" contained skipwhite

hi link   nft_sctp_hdr_field_vtag nftHL_Action
syn match nft_sctp_hdr_field_vtag "vtag" contained skipwhite

hi link   nft_sctp_hdr_field_checksum nftHL_Action
syn match nft_sctp_hdr_field_checksum "checksum" contained skipwhite
...
hi link   nft_tcp_hdr_option_kaf_mptcp_subtype nftHL_Action
syn match nft_tcp_hdr_option_kaf_mptcp_subtype "mptcp" skipwhite contained
\ nextgroup=
\    nft_tcpopt_field_mptcp

syn cluster nft_c_tcp_hdr_option_kind_and_field
\ contains=
\    nft_tcp_hdr_option_kaf_mptcp_subtype,
...
syn match nft_icmp_hdr_field_values "\v([A-Za-z0-9\-\._]{1,32}|[0-9]{1,6})"
...
syn match nft_add_cmd_keyword_table_table_block_chain_chain_block_flags_spec_flags "flags" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_block_table_flowtable_block_hook_keyword_priority_extended_name "\v[a-zA-Z][a-zA-Z]{1,16}"
\ nextgroup=
...
\ contains=
\    @nft_c_add_cmd_table_block_flowtable_block_typeof_key_expr,
\    nft_add_cmd_table_block_flowtable_block_keyword_flags,
\    nft_add_cmd_table_block_flowtable_block_keyword_timeout,
\    nft_add_cmd_table_block_flowtable_block_keyword_gc_interval,
\    @nft_c_stateful_stmt,
\    @nft_c_add_cmd_table_block_flowtable_block_flowtable_mechanism,
\    nft_add_cmd_table_block_flowtable_block_keyword_elements,
\    nft_add_cmd_table_block_flowtable_block_automerge
\ nextgroup=
\    nft_comment_inline,
\    nft_line_stmt_separator
...
" ***************** BEGIN 'add' 'flowtable' ***************
hi link   nft_add_cmd_keyword_flowtable_flowtable_block_hook_keyword_priority_extended_int nftHL_Integer
...
hi link   nft_add_cmd_keyword_flowtable_flowtable_block_hook_keyword_priority nftHL_Action
syn match nft_add_cmd_keyword_flowtable_flowtable_block_hook_keyword_priority "priority" skipwhite contained
\ nextgroup=
\    @nft_c_add_cmd_keyword_flowtable_flowtable_block_hook_keyword_priority_extended
...
\ nextgroup=
\    nft_add_cmd_keyword_flowtable_flowtable_block_hook_keyword_priority
...
hi link   nft_add_cmd_keyword_flowtable_flowtable_block_stmt_separator nftHL_Operator
...
syn match nft_add_cmd_keyword_flowtable_flowtable_spec_flowtable_block_hook "\v[{ ;]\zshook\ze[;} ]" skipwhite skipnl skipempty contained
\ nextgroup=
...
\ nextgroup=
\    @nft_c_add_cmd_keyword_flowtable_flowtable_spec_flowtable_block_flowtable_flag_list,
\    nft_UnexpectedSemicolon,
\    nft_UnexpectedEOS,
\    nft_Error
...
hi link    nft_add_cmd_keyword_flowtable_flowtable_spec_flowtable_block_devices_flowtable_block_expr nftHL_BlockDelimitersFlowtable
...
" [ 'add' ] 'flowtable' table_id flow_id '{' 'devices' '='
" '='->'devices'->flowtable_block->'{'->'flowtable'->add_cmd->base_cmd->line
hi link   nft_add_cmd_keyword_flowtable_flowtable_spec_flowtable_block_devices_equal nftHL_Expression
...
\ nextgroup=
\    nft_add_cmd_keyword_flowtable_flowtable_spec_flowtable_block_devices_equal
...
syn match nft_base_cmd_keyword_map "\v \zsmap\ze " skipwhite contained
\ nextgroup=
\    @nft_c_add_cmd_map_map_spec
