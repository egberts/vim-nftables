...
hi nftHL_Comment     ctermfg=DarkBlue
hi link nftHL_Include     Preproc
hi link nftHL_ToDo        Todo
hi link nftHL_Identifier  Identifier
hi link nftHL_Variable    DarkBlue  " Variable doesn't work, stuck on dark cyan
...
hi link   nft_add_cmd_rule_rule_position_table_spec_end nftHL_Identifier
syn match nft_add_cmd_rule_rule_position_table_spec_end "\v\s{0,13}\i{1,63}" skipwhite contained
\ nextgroup= nft_add_cmd_rule_rule_position_chain_spec

" nft_add_cmd_rule_rule_position_table_spec_end must be the first keyword
...
syn match nft_rt_expr "rt" skipwhite contained
\ nextgroup=
\    nft_nf_key_proto,
\    nft_rt_key
...
syn match nft_meta_stmt_meta_string "\v[a-zA-Z0-9]{1,65}" skipwhite contained
\ nextgroup=
\    nft_meta_stmt_set
...
" meta_key_unqualified->(meta_stmt|meta_key|meta_stmt)
" meta_key_unqualified->meta_stmt
hi link nft_meta_stmt_meta_key_unqualified nftHL_Command
syn match nft_meta_stmt_meta_key_unqualified "\v(mark|iif(|name|type|group)|oif(|name|type|group)|skuid|skgid|nftrace|rtclassid|ibriport|obriport|ibridgename|obridgename|pkttype|cpu|cgroup|ipsec|time|day|hour)" skipwhite contained
\ nextgroup=
\    nft_meta_stmt_meta_key_unqualified_set
...
syn region nft_meta_stmt_at_string_single start="'" end="'" keepend contained
\ contains=nft_meta_stmt_at_string_sans_single_quote

hi link nft_meta_stmt_at_string_double nftHL_String
syn region nft_meta_stmt_at_string_double start="\"" end="\"" keepend contained
...
hi link nft_primary_rhs_expr_block nftHL_Normal
...
hi link nft_limit_config_limit_burst_pkts_keyword_packets nftHL_Number
syn match nft_limit_config_limit_burst_pkts_keyword_packets "packets" skipwhite contained

" num->limit_burst_pkts->limit_config->(add_cmd|create_cmd|limit_block)
hi link nft_limit_config_limit_burst_pkts_num nftHL_Number
syn match nft_limit_config_limit_burst_pkts_num "\v[0-9]{1,11}" skipwhite contained
\ nextgroup=
\    nft_limit_config_limit_burst_pkts_keyword_packets

" 'burst'->limit_burst_pkts->limit_config->(add_cmd|create_cmd|limit_block)
hi link nft_limit_config_limit_burst_pkts_keyword_burst nftHL_Command
syn match nft_limit_config_limit_burst_pkts_keyword_burst "burst" skipwhite contained
\ nextgroup=
\    nft_limit_config_limit_burst_pkts_num
...
\ nextgroup=
\    nft_limit_config_limit_burst_pkts_keyword_burst
...
" 'bytes'->limit_burst_bytes->limit_config->(add_cmd|create_cmd|limit_block)
hi link nft_limit_config_limit_burst_bytes_keyword_packets nftHL_Expression
syn match nft_limit_config_limit_burst_bytes_keyword_packets "bytes" skipwhite contained

" num->limit_burst_bytes->limit_config->(add_cmd|create_cmd|limit_block)
hi link nft_limit_config_limit_burst_bytes_num nftHL_Number
syn match nft_limit_config_limit_burst_bytes_num "\v[0-9]{1,11}" skipwhite contained
\ nextgroup=
\    nft_limit_config_limit_burst_bytes_keyword_packets
...
\ nextgroup=
\    nft_limit_config_limit_burst_bytes_num
...
hi link nft_limit_config_limit_rate_bytes_keyword_bytes nftHL_Expression
syn match nft_limit_config_limit_rate_bytes_keyword_bytes "bytes" skipwhite contained
\ nextgroup=
\    nft_limit_config_limit_rate_bytes_expression_slash

" <string>->limit_rate_bytes->limit_config->(add_cmd|create_cmd|limit_block)
hi link nft_limit_config_limit_rate_bytes_string nftHL_Expression
syn match nft_limit_config_limit_rate_bytes_string "\w{1,32}" skipwhite contained
\ nextgroup=
\    nft_limit_config_limit_burst_bytes_keyword_burst

" <num>->limit_config->(add_cmd|create_cmd|limit_block)
hi link nft_limit_config_num nftHL_Number
syn match nft_limit_config_num "\v[0-9]{1,11}" skipwhite contained
\ nextgroup=
\    nft_limit_config_limit_rate_pkts_expression_slash,
\    nft_limit_config_limit_rate_bytes_keyword_bytes,
\    nft_limit_config_limit_rate_bytes_string_unit
...
hi link nft_ct_timeout_config_keyword_policy_block nftHL_Normal
...
hi link nft_ct_helper_config_type_string_quoted nftHL_Normal
syn region nft_ct_helper_config_type_string_quoted start="\"" end="\"" skipwhite contained
...
syn match nft_secmark_config_string_sans_double_quote "\v[a-zA-Z0-9\/\\\[\]\"]{1,64}" keepend contained
...
syn match nft_secmark_config_string_sans_single_quote "\v[a-zA-Z0-9\/\\\[\]\']{1,64}" keepend contained

" single_string->secmark_config->(add_cmd|create_cmd|secmark_block)
hi link nft_secmark_config_string_single nftHL_String
syn region nft_secmark_config_string_single start="'" end="'" keepend contained
\ contains=nft_secmark_config_string_sans_single_quote

" double_string->secmark_config->(add_cmd|create_cmd|secmark_block)
hi link nft_secmark_config_string_double nftHL_String
syn region nft_secmark_config_string_double start="\"" end="\"" keepend contained
...
hi link nft_initializer_expr_num nftHL_Integer
syn match nft_initializer_expr_num "\v[0-9]{1,11}" skipwhite contained

" '-'->initializer_expr->common_block
hi link nft_initializer_expr_dash nftHL_Element
syn match nft_initializer_expr_dash /-/ skipwhite contained
\ nextgroup=
\    nft_initializer_expr_num

" '{'->initializer_expr->common_block
hi link   nft_initializer_expr_block nftHL_Element
syn region nft_initializer_expr_block start=/{/ end=/}/ skipwhite contained

" initializer_expr->common_block
syn cluster nft_initializer_expr
\ contains=
\    nft_initializer_expr_dash,
\    nft_initializer_expr_block,
\    @nft_c_rhs_expr,
\    @nft_c_list_rhs_expr
...
hi link nft_set_elem_stmt_limit_burst_pkts_keyword_packets nftHL_Number
syn match nft_set_elem_stmt_limit_burst_pkts_keyword_packets "packets" skipwhite contained

" num->limit_burst_pkts->set_elem_stmt->set_elem_expr_alloc
hi link nft_set_elem_stmt_limit_burst_pkts_num nftHL_Number
syn match nft_set_elem_stmt_limit_burst_pkts_num "\v[0-9]{1,11}" skipwhite contained
\ nextgroup=
\    nft_set_elem_stmt_limit_burst_pkts_keyword_packets

" 'burst'->limit_burst_pkts->->set_elem_stmt->set_elem_expr_alloc
hi link nft_set_elem_stmt_limit_burst_pkts_keyword_burst nftHL_Command
syn match nft_set_elem_stmt_limit_burst_pkts_keyword_burst "burst" skipwhite contained
\ nextgroup=
\    nft_set_elem_stmt_limit_burst_pkts_num
...
\ nextgroup=
\    nft_set_elem_stmt_limit_burst_pkts_keyword_burst
...
hi link nft_set_elem_stmt_limit_burst_bytes_keyword_packets nftHL_Expression
syn match nft_set_elem_stmt_limit_burst_bytes_keyword_packets "bytes" skipwhite contained

" num->limit_burst_bytes->set_elem_stmt->set_elem_expr_alloc
hi link nft_set_elem_stmt_limit_burst_bytes_num nftHL_Number
syn match nft_set_elem_stmt_limit_burst_bytes_num "\v[0-9]{1,11}" skipwhite contained
\ nextgroup=
\    nft_set_elem_stmt_limit_burst_bytes_keyword_packets
...
\ nextgroup=
\    nft_set_elem_stmt_limit_burst_bytes_num
...
hi link nft_set_elem_stmt_limit_rate_bytes_keyword_bytes nftHL_Expression
syn match nft_set_elem_stmt_limit_rate_bytes_keyword_bytes "bytes" skipwhite contained
\ nextgroup=
\    nft_set_elem_stmt_limit_rate_bytes_expression_slash

" <string>->limit_rate_bytes->set_elem_stmt->set_elem_expr_alloc
hi link nft_set_elem_stmt_limit_rate_bytes_string nftHL_Expression
syn match nft_set_elem_stmt_limit_rate_bytes_string "\w{1,32}" skipwhite contained
\ nextgroup=
\    nft_set_elem_stmt_limit_burst_bytes_keyword_burst

" <num>->limit_rate->'limit'->set_elem_stmt->set_elem_expr_alloc
hi link nft_set_elem_stmt_limit_rate_num nftHL_Number
syn match nft_set_elem_stmt_limit_rate_num "\v[0-9]{1,11}" skipwhite contained
\ nextgroup=
\    nft_set_elem_stmt_limit_rate_pkts_expression_slash,
\    nft_set_elem_stmt_limit_rate_bytes_keyword_bytes,
\    nft_set_elem_stmt_limit_rate_bytes_string_unit
...
hi link   nft_set_expr nftHL_Normal
...
" 'osf' 'ttl' <string> ('hdrversion'|'name')
" osf_ttl->osf_expr->(primary_expr|primary_stmt_expr)
hi link   nft_osf_expr_hdrversion_or_name nftHL_String
syn match nft_osf_expr_hdrversion_or_name "\v(hdrversion|name)" skipwhite contained
...
hi link   nft_meter_stmt_alloc_block nftHL_Normal
...
\ nextgroup=nft_meter_stmt_alloc_block
...
\ nextgroup=nft_meter_stmt_alloc_num
...
syn match nft_meter_stmt_alloc "meter" skipwhite contained
\ nextgroup=
...
" 'set' 'at' <identifier> '{'
hi link nft_map_stmt_block_delimiters nftHL_Normal
...
\ contains=
\    @nft_c_map_stmt_set_ref_symbol_expr,
...
\ contains=
\    @nft_c_set_stmt_set_ref_symbol_expr,
...
hi link nft_set_stmt_block_delimiters nftHL_Normal
...
" queue_stmt_flags->(queue_stmt|queue_stmt_arg)
" <integer> | $<variable>
" 'queue' 'flags' ('bypass'|'fanout') 'queuenum' queue_stmt_expr_simple
...
syn match nft_c_queue_stmt_compat_arg_queuenum "queuenum" skipwhite contained
\ nextgroup=
\    @nft_c_queue_stmt_expr_simple
...
" 'queue' 'flags' ('bypass'|'fanout') 'queuenum' queue_stmt_expr_simple
" 'queuenum'->queue_stmt->stmt
hi link nft_queue_stmt_keyword_flags_queue_stmt_flags_queuenum_keyword nftHL_Command
syn match nft_queue_stmt_keyword_flags_queue_stmt_flags_queuenum_keyword "queuenum" skipwhite contained
...
hi link    nft_primary_stmt_expr_block_delimiters nftHL_Normal
...
" 'reject' 'with' 'icmp6' 'type'
" reject_opts->reject_stmt->stmt
syn cluster nft_c_reject_with_expr "type" skipwhite contained
\ nextgroup=
\    nft_keyword_string,
\    nft_integer_expr
...
syn match nft_add_cmd_limit_obj_spec_family_spec "\v(ip[6]?|inet|arp|bridge|netdev)" skipwhite contained
\ nextgroup=
...
hi link   nft_base_cmd_add_limit nftHL_Command
syn match nft_base_cmd_add_limit "\v\s{0,32}(limit|add\s{1,16}limit)\s{1,16}" contained
\ nextgroup=
\    @nft_c_add_cmd_limit_obj_spec
...
syn match nft_base_cmd_create "\vcreate\s{1,16}" contained
\ nextgroup=
...
hi link   nft_base_cmd_replace_rule nftHL_Statement
syn match nft_base_cmd_replace_rule "rule" skipwhite contained
\ nextgroup=
\    @nft_c_base_cmd_replace_rule_ruleid_spec_chain_spec_table_spec_family_spec

" base_cmd 'replace'
hi link   nft_base_cmd_replace nftHL_Command
syn match nft_base_cmd_replace "replace" skipwhite contained
\ nextgroup=
\    nft_base_cmd_replace_rule
...
syn match nft_add_table_table_block_chain_block_hook_spec "type" skipwhite contained
...
syn region nft_add_table_table_block_chain_chain_block_devices_flowtable_expr_block skipwhite contained
\ start=/{/ end=/}/ keepend
\ contains=
...
syn match nft_add_table_table_block_chain_chain_identifier_string_sans_double_quote "\v[a-zA-Z0-9\/\\_\.]{1,64}" keepend skipwhite contained

" add_cmd 'table' table_block 'chain' chain_spec table_id chain_id
hi link   nft_add_table_table_block_chain_chain_identifier_string_sans_single_quote nftHL_Chain
syn match nft_add_table_table_block_chain_chain_identifier_string_sans_single_quote "\v[a-zA-Z0-9\/\\_\.]{1,64}" keepend skipwhite contained
...
hi link   nft_add_cmd_counter_counter_config_last_packet nftHL_Identifier
syn match nft_add_cmd_counter_counter_config_last_packet "packet" skipwhite contained
\ nextgroup=
...
\    nft_add_cmd_counter_Semicolon,
\    nft_add_cmd_counter_obj_id_Error_Always
...
syn cluster nft_c_add_cmd_counter_obj_spec_obj_last
\ contains=
\    nft_add_cmd_counter_counter_config_last_packet,
\    nft_add_cmd_counter_counter_block,
\    nft_add_cmd_counter_Semicolon,
...
\ nextgroup=
\    @nft_c_add_cmd_counter_obj_spec_obj_last
...
syn match nft_base_cmd_add_counter "\v(counter\s{1,16}|add\s{1,16}counter\s{1,16})" skipwhite contained
\ nextgroup=@nft_c_add_cmd_counter_obj_spec
" do not add ^ regex to nft_base_cmd_add_counter, done by nft_line
...
syn match nft_base_cmd_add_chain "\v(chain\s{1,16}|add\s*chain\s{1,16})" contained
\ nextgroup=@nft_c_add_cmd_chain_spec
" do not add ^ regex to nft_base_cmd_add_chain, done already by nft_line
...
syn match nft_base_cmd_add_table "\v\zs(add\s{1,15}table\s{1,15}|table\s{1,15})" contained
\ nextgroup=
\    @nft_c_add_table_spec
" do not add ^ regex to nft_base_cmd_add_table, done already by nft_line
...
syn match nft_add_cmd_set_set_spec_set_block_typeof_key_expr_typeof_expr_primary_expr skipwhite contained
...
syn match nft_add_cmd_set_set_spec_set_block_typeof_key_expr_type_data_type_expr "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
syn match nft_add_cmd_set_set_spec_set_block_time_spec "\v[a-zA-Z0-9\/\\_\.\:]{1,31}" skipwhite contained
...
hi link   nft_add_cmd_set_set_spec_set_block_elements_set_block_expr_set_expr nftHL_Normal
...
hi link  nft_add_cmd_set_set_spec_set_block_element_set_block_semicolon nftHL_Operator
syn match nft_add_cmd_set_set_spec_set_block_element_set_block_semicolon /;/ skipwhite contained

hi link    nft_add_cmd_set_set_spec_set_block_elements_set_block nftHL_Normal
syn region nft_add_cmd_set_set_spec_set_block_elements_set_block start=/{/ end=/}/ skipwhite contained
\ contains=
\    nft_add_cmd_set_set_spec_set_block_element_set_block_elements_block_items
\ nextgroup=nft_add_cmd_set_set_spec_set_block_separator
...
" base_cmd add_cmd 'set' set_spec '{' set_block 'elements' '='
hi link   nft_add_cmd_set_set_spec_set_block_elements_equal nftHL_Normal
syn match nft_add_cmd_set_set_spec_set_block_elements_equal /=/ skipwhite contained
\ nextgroup=
\    nft_add_cmd_set_set_spec_set_block_elements_set_block
...
" base_cmd 'reset' [ 'set' | 'map' ] table_id spec_id '$'identifier
hi link   nft_add_cmd_set_set_spec_set_block_expr_variable_expr nftHL_Position
syn match nft_add_cmd_set_set_spec_set_block_expr_variable_expr "\v\$[a-zA-Z][a-zA-Z0-9\\\/_\.]{0,31}" contained
\ nextgroup=
\    nft_Semicolon,
\    nft_UnexpectedEOS,
\    nft_Error
...
syn match nft_add_cmd_set_set_spec_set_id "\v[a-zA-Z][a-zA-Z0-9\\\/_\.]{0,63}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_set_set_spec_table_spec_family_spec_table_id "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}\s{1,16}" contained
\ nextgroup=
...
syn match nft_add_cmd_set_set_spec_table_spec_family_spec_family_spec_explicit skipwhite contained
...
"syn match nft_base_cmd_add_set "\v\s{0,32}(add\s{1,15}set\s{1,16}|set\s{1,16})" contained
syn match nft_base_cmd_add_set "\v(set|add\s{1,16}set)\s{1,16}" contained
\ nextgroup=
\    @nft_c_add_cmd_set_set_spec,
\    nft_UnexpectedEOS
" do not add ^ regex to nft_base_cmd_add_set, already done by nft_line
...
syn match nft_base_cmd_add_map "\v(add\s{1,15}map|map)\s{1,63}" contained
\ nextgroup=
...
syn match nft_add_cmd_flowtable_flowtable_spec_identifier_flowtable "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_flowtable_flowtable_spec_identifier_chain "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_flowtable_flowtable_spec_table_spec_family_spec_identifier_table "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
\ nextgroup=
\    nft_add_cmd_flowtable_flowtable_spec_identifier_flowtable
...
syn match nft_add_cmd_flowtable_flowtable_spec_table_spec_family_spec_family_spec_explicit skipwhite contained
\ "\v(ip(6)?|inet|arp|bridge|netdev)"
...
syn match nft_base_cmd_add_flowtable "\v(add\s{1,15}flowtable|flowtable)\s{1,16}" contained
\ nextgroup=
\    @nft_c_add_cmd_flowtable_flowtable_spec
" do not add ^ regex to nft_base_cmd_add_flowtable, already done by nft_line
...
syn match nft_add_cmd_rule_rule_position_chain_spec_table_spec_identifier "\v([a-zA-Z][A-Za-z0-9\/\\_\.]{0,63}){2}" skipwhite contained
\ nextgroup=
...
syn match nft_add_cmd_rule_rule_position_keywords_position_handle_index skipwhite contained
\ "\v(position|handle|index)"
\ nextgroup=nft_add_cmd_rule_rule_position_chain_spec_position_spec_num

" base_cmd add_cmd [[ 'add' ] 'rule' ] chain_spec
hi link   nft_add_cmd_rule_rule_position_chain_spec nftHL_Identifier
syn match nft_add_cmd_rule_rule_position_chain_spec "\v[A-Za-z][A-Za-z0-9\\\/_\.\-]{0,63}" skipwhite contained
\ nextgroup=
\    nft_add_cmd_rule_rule_position_keywords_position_handle_index

" base_cmd add_cmd [[ 'add' ] 'rule' ] table_spec
hi link   nft_add_cmd_rule_rule_position_table_spec nftHL_Identifier
syn match nft_add_cmd_rule_rule_position_table_spec "\v[A-Za-z][A-Za-z0-9\\\/_\.]{0,63}" skipwhite contained
\ nextgroup=nft_add_cmd_rule_rule_position_chain_spec

hi link   nft_add_cmd_rule_rule_position_family_spec_explicit nftHL_Family
syn match nft_add_cmd_rule_rule_position_family_spec_explicit "\v(ip[6]?|arp|inet|bridge|netdev)" skipwhite contained
\ nextgroup=nft_add_cmd_rule_rule_position_table_spec
...
\ contains=@nft_base_cmd_add_ct_timeout_obj_spec_table_spec
...
syn cluster nft_c_base_cmd_add_ct_helper_obj_spec
...
\ nextgroup=@nft_c_base_cmd_add_ct_helper_obj_spec
...
\    nft_add_cmd_rule_rule_position_family_spec_explicit,
\    nft_add_cmd_rule_rule_position_table_spec_end
...
syn match nft_base_cmd_reset_rule_ruleset_spec_id_table "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
syn match nft_base_cmd_reset_rules_ruleset_spec_id_chain "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained

" base_cmd 'reset' 'rules' table_id
hi link   nft_base_cmd_reset_rules_ruleset_spec_id_table nftHL_Table
syn match nft_base_cmd_reset_rules_ruleset_spec_id_table "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
\ "\v(tcp|udplite|udp|esp|ah|icmp6|icmp|igmp|gre|comp|dccp|sctp|direct)"
...
syn match nft_get_cmd_set_id "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
\ nextgroup=
\    @nft_c_base_cmd_get_cmd_set_block_expr

" base_cmd 'get' 'element' [ family_spec_explicit ] table_id set_id
hi link   nft_base_cmd_get_cmd_table_id nftHL_Table
syn match nft_base_cmd_get_cmd_table_id "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
\ nextgroup=
\    nft_get_cmd_set_id
...
syn match nft_list_table_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
\ nextgroup=
\    nft_EOS
...
syn match nft_list_chain_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained

" base_cmd list_cmd 'chain' [ family_spec ] table_spec
hi link nft_list_chain_table_spec_identifier nftHL_Identifier
syn match nft_list_chain_table_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
syn match nft_list_set_chain_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained

" list_cmd 'set' set_spec family_spec family_spec_explicit
hi link   nft_list_set_table_spec_identifier nftHL_Identifier
syn match nft_list_set_table_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
syn match nft_list_flowtables_ruleset_table_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
syn match nft_flush_table_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
syn match nft_flush_chain_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained

" base_cmd flush_cmd 'chain' [ family_spec ] table_spec
hi link nft_flush_chain_table_spec_identifier nftHL_Identifier
syn match nft_flush_chain_table_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
...
syn match nft_flush_set_chain_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained

" flush_cmd 'set' set_spec family_spec family_spec_explicit
hi link   nft_flush_set_table_spec_identifier nftHL_Identifier
syn match nft_flush_set_table_spec_identifier "\v[a-zA-Z][a-zA-Z0-9\/\\_\.]{0,63}" skipwhite contained
